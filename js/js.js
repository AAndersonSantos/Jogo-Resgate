...
function start() { // Inicio da funзгo start()
    ...
    let ponteiro = document.getElementById('fundoGame');
    ponteiro.style.cursor = 'none';
    ...
    function moveinimigo2() {
        ...
        $("#inimigo2").css("left", posicaoX - vcarro);
    ...
    function disparo() {
        ...
        function executaDisparo() {
            ...
            $("#disparo").css("left", posicaoX + disparar);
    ...
    function gameOver() {
        ...
        let ponteiro = document.getElementById('fundoGame');
        ponteiro.style.cursor = 'context-menu';
        ...
        $("#fim").html("<div id='reinicia' onClick=reiniciaJogo()><h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<h3>Clique Aqui Para Jogar Novamente</h3></div>");
